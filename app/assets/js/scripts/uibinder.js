...
async function showMainUI(data){
    ...
    setTimeout(() => {
        ...
        document.body.style.setProperty('--bg-image', `url('assets/images/backgrounds/${document.body.getAttribute('bkid')}.png')`)
        $('#main').show()
        ...
        // Do not show the welcome page on first launch; proceed as normal.
        if(isLoggedIn){
